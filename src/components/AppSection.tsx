...
export function AppSection() {
  return (
    <section id="app" className="py-16 md:py-24 bg-section-dark text-section-dark-foreground relative overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="font-heading text-2xl md:text-3xl lg:text-4xl font-bold text-section-dark-foreground mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-8 gap-y-3 mb-10">
              {appFeatures.map((feature, index) => (
                <div key={index} className="flex items-center gap-2">
                  ...
                  <span className="text-section-dark-foreground/80 text-sm">{feature}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 lg:gap-12">
            ...
            <div className="flex flex-col items-center">
              <div className="w-32 h-32 bg-section-dark-foreground p-2 rounded-lg">
                <div className="w-full h-full bg-section-dark rounded grid grid-cols-5 grid-rows-5 gap-0.5 p-1">
                  {/* QR Code Pattern */}
              ...
              <p className="text-section-dark-foreground/70 text-sm mt-3">Baixe o app ConnectFibra</p>
            </div>

            {/* Phone Mockup */}
            <div className="relative">
              <div className="w-48 md:w-56 bg-section-dark-foreground/10 rounded-[2rem] p-2">
            ...
            <div className="flex flex-col gap-3">
              <a
                href="#"
                className="flex items-center gap-3 px-4 py-2 rounded-lg border border-section-dark-foreground/20 hover:bg-section-dark-foreground/10 transition-colors"
              >
                <svg className="w-6 h-6 text-section-dark-foreground" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z" />
                </svg>
                <div className="text-left">
                  <p className="text-[10px] text-section-dark-foreground/60">Disponível na</p>
                  <p className="text-sm font-semibold text-section-dark-foreground">App Store</p>
                </div>
              </a>
              <a
                href="#"
              ...
              >
                ...
                <div className="text-left">
                  <p className="text-[10px] text-section-dark-foreground/60">Disponível no</p>
                  <p className="text-sm font-semibold text-section-dark-foreground">Google Play</p>
                </div>
              </a>
            </div>
          </div>
