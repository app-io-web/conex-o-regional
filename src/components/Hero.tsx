...
import { Zap, Shield, Headphones, ChevronLeft, ChevronRight } from "lucide-react";
...
const slides = [
  {
    image: slideWifi,
    badge: "Internet de alta velocidade para sua região",
    title: "Conecte-se ao futuro com",
    highlight: "fibra óptica",
    description: "Velocidade ultra-rápida, estabilidade incomparável e suporte 24h. A internet que sua casa ou empresa merece.",
  },
  {
    image: slideFibra,
    badge: "Fibra óptica para toda a família",
    title: "Streaming e games sem",
    highlight: "travamentos",
    description: "Assista, jogue e trabalhe ao mesmo tempo. Nossa fibra suporta todos os seus dispositivos conectados.",
  },
  {
    image: slideSuporte,
    badge: "Suporte técnico especializado",
    title: "Atendimento 24h para",
    highlight: "você",
    description: "Equipe técnica sempre disponível. Problemas resolvidos com rapidez e eficiência.",
  },
];
...
export function Hero() {
  ...
  return (
    <section id="inicio" className="relative min-h-screen flex flex-col md:flex-row md:items-center pt-20 overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-8 mt-10 md:mt-16 animate-fade-up" style={{ animationDelay: '0.4s' }}>
            <div className="flex items-center gap-3 text-muted-foreground">
              ...
              <div className="text-left">
                <p className="font-semibold text-foreground text-sm md:text-base">Até 1 Gbps</p>
                <p className="text-xs md:text-sm">de velocidade</p>
              </div>
            </div>
            <div className="flex items-center gap-3 text-muted-foreground">
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-primary/10 flex items-center justify-center">
              ...
              <div className="text-left">
                <p className="font-semibold text-foreground text-sm md:text-base">99.9%</p>
                <p className="text-xs md:text-sm">de estabilidade</p>
              </div>
            </div>
            <div className="flex items-center gap-3 text-muted-foreground">
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-primary/10 flex items-center justify-center">
              ...
              <div className="text-left">
                <p className="font-semibold text-foreground text-sm md:text-base">Suporte 24h</p>
                <p className="text-xs md:text-sm">sempre disponível</p>
              </div>
            </div>
          </div>
